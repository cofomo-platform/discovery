...
==== Sample Request
include::{snippets}/lookup-travel/http-request.adoc[]

==== Fields of Request Body
include::{snippets}/lookup-travel/request-fields.adoc[]

==== Sample Response
include::{snippets}/lookup-travel/http-response.adoc[]


=== By location

==== Sample Request
include::{snippets}/lookup-location/http-request.adoc[]

==== Fields of Request Body
include::{snippets}/lookup-location/request-fields.adoc[]

==== Sample Response
include::{snippets}/lookup-location/http-response.adoc[]
